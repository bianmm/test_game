...
class PayNotifyCallBack extends WxPayNotify
{
	...
	public function NotifyProcess($data, &$msg)
	{
		...
		// 发货
        $rst = json_decode(file_get_contents('http://192.168.1.31:8080/ipay/dowx?cmd=wxpay_confirm&pass=sadasdfa32s&blh='.$data['attach'].'&preorder_id='.$data['out_trade_no'].'&exorder_id='.$data['transaction_id'].'&costs='.$data['total_fee']));
		if ($rst.ret != 1) {
