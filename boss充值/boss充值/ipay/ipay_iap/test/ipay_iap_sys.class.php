...
class ipay_iap_sys {
    ...
    ///////////////////////////////////////////
    const IPAY_PREORDER_CMD_ID = 0xA043;
    ...
    ///////////////////////////////////////////
    const IPAY_NOTIFY_CMD_ID = 0xA044;

        public function receipt_verify($trans_id, $sign,$transdata,$user_id) {
        $req_body = pack('LSSa'.(strlen($sign)+1).'a'.(strlen($transdata)+1), $trans_id, strlen($sign)+1,strlen($transdata)+1, $sign,$transdata);
        $req_header = pack('LLSLL', 18 + strlen($req_body), 0,
